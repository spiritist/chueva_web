...
const ExpSection = () => (
  <section id="experience" className="bg-gray-50 py-8 sm:py-12 md:py-16">
      ...
      >
        ...
        <div className="flex flex-col md:flex-row items-center md:space-x-6 lg:space-x-8">
          ...
          <div className="w-full md:w-2/3 lg:w-3/5 mb-6 md:mb-0 text-center md:text-left"> {/* Адаптивная ширина и выравнивание текста */}
            <Title
              level={3}
              className="text-2xl sm:text-3xl lg:text-[3.2rem] !leading-tight mb-3 sm:mb-4" // Адаптивный размер шрифта
              style={{
                fontFamily: 'Georgia Pro, serif',
            ...
            <Paragraph
              className="text-xl sm:text-2xl lg:text-[3rem] !leading-tight text-zinc-800 m-0" // Адаптивный размер, цвет, убрали w-120
              style={{
                fontFamily: 'Georgia Pro, serif',
          ...
          <div className="w-full md:w-1/3 lg:w-2/5 flex justify-center md:justify-end">
            <div className="relative w-64 h-64 sm:w-72 sm:h-72 md:w-80 md:h-80 lg:w-90 lg:h-90 rounded-lg overflow-hidden"> {/* Адаптивные размеры для изображения */}
              <Image
